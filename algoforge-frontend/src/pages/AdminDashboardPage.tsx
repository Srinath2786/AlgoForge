    ...
    <DashboardShell>
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <h1 className="mt-2 font-display text-3xl font-semibold tracking-tight">Platform overview</h1>
          <p className="mt-1 text-sm text-ink-muted">
            Live counts pulled straight from your problem catalog and leaderboard.
          </p>
        </div>
